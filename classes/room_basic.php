...
class room_basic extends crud
{
    ...
    /**
     * Returns short name (Acronym + name)
     * @return string
     */
    public function get_short_name()
    {
        return $this->building_shortname . ' ' . $this->name;
    }


    /**
     * Return full name (Building name + shortname + name)
     * @return string
     */
    public function get_full_name()
    {
        return $this->building_name . ' - ' . $this->building_shortname . ' ' . $this->name;
    }
